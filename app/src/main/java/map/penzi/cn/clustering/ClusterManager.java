...
import map.penzi.cn.clustering.algo.Algorithm;
import map.penzi.cn.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
import map.penzi.cn.clustering.algo.PreCachingAlgorithmDecorator;
import map.penzi.cn.clustering.view.ClusterRenderer;
 ...
 * <p/>
 * ClusterManager should be added to the map as an: <ul> <li>{@link }</li>
 */
public class ClusterManager<T extends ClusterItem> implements
    ...
    public ClusterManager(Context context, TencentMap map) {
        this(context, map, new MarkerManager(map));
    }

    public ClusterManager(Context context, TencentMap map, MarkerManager markerManager) {
        mMap = map;
    ...
    public void onCameraChange(CameraPosition cameraPosition) {
        if (mRenderer instanceof TencentMap.OnCameraChangeListener) {
            ((TencentMap.OnCameraChangeListener) mRenderer).onCameraChange(cameraPosition);
        }
