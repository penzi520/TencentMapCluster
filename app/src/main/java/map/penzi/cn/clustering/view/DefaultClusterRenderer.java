...
package map.penzi.cn.clustering.view;
...
import map.penzi.cn.clustering.MarkerManager;
import map.penzi.cn.clustering.projection.Point;
import map.penzi.cn.clustering.projection.SphericalMercatorProjection;
import map.penzi.cn.clustering.ui.IconGenerator;
import map.penzi.cn.clustering.ui.SquareTextView;
import map.penzi.cn.demo.R;

import static map.penzi.cn.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    public DefaultClusterRenderer(Context context, TencentMap map, ClusterManager<T> clusterManager) {
        mMap = map;
    ...
    @Override
    public void onAdd() {
        mClusterManager.getMarkerCollection().setOnMarkerClickListener(new TencentMap.OnMarkerClickListener() {
            @Override
        ...
        mClusterManager.getMarkerCollection().setOnInfoWindowClickListener(new TencentMap.OnInfoWindowClickListener() {
            @Override
        ...
        mClusterManager.getClusterMarkerCollection().setOnMarkerClickListener(new TencentMap.OnMarkerClickListener() {
            @Override
            public boolean onMarkerClick(Marker marker) {
        ...
        mClusterManager.getClusterMarkerCollection().setOnInfoWindowClickListener(new TencentMap.OnInfoWindowClickListener() {
            @Override
            public void onInfoWindowClick(Marker marker) {
